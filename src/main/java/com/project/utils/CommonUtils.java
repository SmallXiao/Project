...
public class CommonUtils {
    ...
    private static Properties getconfig(){
        ...
        input = Constants.class.getClassLoader().getResourceAsStream("sysinfo.properties");
    ...
    public static String getrestpassword(){
        ...
        RESTPASSWORD = StringUtils.trim((String)getconfig().get("rest_password"));
        return RESTPASSWORD;
    }
    ...
    public static String getEncodingAesKey() {
        ...
        encodingAesKey = StringUtils.trim((String)getconfig().get("encoding_aes_key"));
        return encodingAesKey;
    }
    ...
    public static String getClient(String ip, String port,String restURL){
        ...
        if(baseUrl.startsWith("https")){
            JSONObject jtoken = WeChatUtil.httpsRequest(baseUrl+"/seeyon/rest/token/"+getrestname()+"/"+getrestpassword(),"GET",null);
            returnstr = WeChatUtil.httpsRequestRest(baseUrl+"/seeyon/rest/"+restURL+tokenname+jtoken.getString("id"),"GET",null);

        }else{
            JSONObject jtoken = WeChatUtil.httpRequest(baseUrl+"/seeyon/rest/token/"+getrestname()+"/"+getrestpassword(),"GET",null);
            returnstr = WeChatUtil.httpRequestRest(baseUrl+"/seeyon/rest/"+restURL+tokenname+jtoken.getString("id"),"GET",null);
